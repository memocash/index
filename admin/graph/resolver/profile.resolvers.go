...
func (r *profileResolver) Posts(ctx context.Context, obj *model.Profile, start *int, newest *bool) ([]*model.Post, error) {
	...
	addrMemoPosts, err := memo.GetAddrHeightPosts(ctx, [][25]byte{*addr}, newest != nil && *newest)
	if err != nil {

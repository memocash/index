...
func (l *TxRawLoader) LoadThunk(key string) func() (string, error) {
	...
	if l.batch == nil {
		l.batch = &txRawLoaderBatch{done: make(chan struct{})}
	}
	batch := l.batch
...
func (b *txRawLoaderBatch) keyIndex(l *TxRawLoader, key string) int {
...
func (b *txRawLoaderBatch) startTimer(l *TxRawLoader) {
	time.Sleep(l.wait)
	l.mu.Lock()
...
func (b *txRawLoaderBatch) end(l *TxRawLoader) {

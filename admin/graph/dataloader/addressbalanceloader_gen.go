...
type AddressBalanceLoader struct {
	...
	batch *addressBalanceLoaderBatch

	// mutex to prevent races
	mu sync.Mutex
}

type addressBalanceLoaderBatch struct {
	keys    []string
	data    []int64
	error   []error
	closing bool
...
func (l *AddressBalanceLoader) LoadThunk(key string) func() (int64, error) {
	...
	if l.batch == nil {
		l.batch = &addressBalanceLoaderBatch{done: make(chan struct{})}
	}
	batch := l.batch
...
func (l *AddressBalanceLoader) unsafeSet(key string, value int64) {
	if l.cache == nil {
...
func (b *addressBalanceLoaderBatch) keyIndex(l *AddressBalanceLoader, key string) int {
...
func (b *addressBalanceLoaderBatch) startTimer(l *AddressBalanceLoader) {
	time.Sleep(l.wait)
	l.mu.Lock()
...
func (b *addressBalanceLoaderBatch) end(l *AddressBalanceLoader) {

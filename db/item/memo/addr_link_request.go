...
func GetAddrLinkRequestsSingle(ctx context.Context, addr [25]byte, start time.Time, limit uint32) ([]*AddrLinkRequest, error) {
	...
	if err := dbClient.GetByPrefix(ctx, db.TopicMemoAddrLinkRequest, prefix,

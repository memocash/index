...
type FilterPattern struct {
	...
	Start         []byte                 `protobuf:"bytes,3,opt,name=start,proto3" json:"start,omitempty"` // asc: inclusive lower bound; desc: exclusive upper bound
...
type Pattern struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Parts         [][]byte               `protobuf:"bytes,1,rep,name=parts,proto3" json:"parts,omitempty"`
	AnchorStart   bool                   `protobuf:"varint,2,opt,name=anchor_start,json=anchorStart,proto3" json:"anchor_start,omitempty"`
	AnchorEnd     bool                   `protobuf:"varint,3,opt,name=anchor_end,json=anchorEnd,proto3" json:"anchor_end,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Pattern) GetAnchorStart() bool {
	if x != nil {
		return x.AnchorStart
	}
	return false
}

func (x *Pattern) GetAnchorEnd() bool {
	if x != nil {
		return x.AnchorEnd
	}
	return false
...
const file_queue_proto_rawDesc = "" +
	...
	"\aPattern\x12\x14\n" +
	"\x05parts\x18\x01 \x03(\fR\x05parts\x12!\n" +
	"\fanchor_start\x18\x02 \x01(\bR\vanchorStart\x12\x1d\n" +
	"\n" +
...
var file_queue_proto_depIdxs = []int32{
	...
	8,  // 17: queue_pb.Queue.CompactAll:input_type -> queue_pb.EmptyRequest
	3,  // 18: queue_pb.Queue.SaveMessages:output_type -> queue_pb.ErrorReply
	3,  // 19: queue_pb.Queue.DeleteMessages:output_type -> queue_pb.ErrorReply
	...
	3,  // 27: queue_pb.Queue.CompactAll:output_type -> queue_pb.ErrorReply

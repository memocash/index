...
const (
	...
	Queue_CompactAll_FullMethodName        = "/queue_pb.Queue/CompactAll"
)
...
type QueueClient interface {
	...
	CompactAll(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*ErrorReply, error)
}
...
func (c *queueClient) GetStreamMessages(ctx context.Context, in *RequestStream, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Message], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Queue_ServiceDesc.Streams[0], Queue_GetStreamMessages_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[RequestStream, Message]{ClientStream: stream}
...
type Queue_GetStreamMessagesClient = grpc.ServerStreamingClient[Message]
...
func (c *queueClient) CompactAll(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*ErrorReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ErrorReply)
	err := c.cc.Invoke(ctx, Queue_CompactAll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueueServer interface {
	...
	CompactAll(context.Context, *EmptyRequest) (*ErrorReply, error)
...
func (UnimplementedQueueServer) CompactAll(context.Context, *EmptyRequest) (*ErrorReply, error) {
...
func RegisterQueueServer(s grpc.ServiceRegistrar, srv QueueServer) {
	// If the following call panics, it indicates UnimplementedQueueServer was
...
func _Queue_GetStreamMessages_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(QueueServer).GetStreamMessages(m, &grpc.GenericServerStream[RequestStream, Message]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Queue_GetStreamMessagesServer = grpc.ServerStreamingServer[Message]
...
func _Queue_CompactAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmptyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueueServer).CompactAll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Queue_CompactAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueueServer).CompactAll(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Queue_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Queue_CompactAll_Handler,
		},
	},

...
var file_double_spend_proto_rawDesc = []byte{
	...
	0x02, 0x74, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x02, 0x74, 0x78, 0x42, 0x36, 0x5a,
...
var file_double_spend_proto_goTypes = []any{
...
func file_double_spend_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_double_spend_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_double_spend_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_double_spend_proto_msgTypes[2].Exporter = func(v any, i int) any {
